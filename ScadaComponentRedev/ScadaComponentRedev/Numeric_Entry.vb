...
Public Class Numeric_Entry
    ...
    <Browsable(False), Category("ADDRESS")> _
    ...
    <Browsable(True), Category("_ADDRESS"), Description("The tag which associated with control")> _
    ...
    <Browsable(False), Category("ADDRESS")>
    ...
    <Browsable(False), Category("LIMITS")>
    ...
    <Category("_Misc"), Browsable(True), Description("Indicates whether the control is enabled or not")>
...
Category("_VISIBLE"), Description("The tag which determines whether the control is visible or hidden")> _
    ...
    Dim loginRgi As New Login_Register()


    Private Sub Numeric_Entry_MouseClick(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseClick
    ...
    Sub write16bit()
        If IsNumeric(Me.Text) Then
                ...
                If Comparison_Typeval.ToString = "InDirect" Then
                    ...
                    Using reader As SqlDataReader = sqlcmd1.ExecuteReader()
                        While reader.Read
                            ...
                            ElseIf reader(0) = MinvalueD Then
            ...
            End If
            Dim num_keyboard As New Numeric_Keyboard(WriteAddress, Val(Me.Text), Min_value, Max_value, Gain, "16BIT", recordev.ToString, RecordMessage, RecordActionMessage)
        ...
        If IsNumeric(Me.Text) Then
            If Comparisonval = True Then
                ...
                If Comparison_Typeval.ToString = "InDirect" Then
                    ...
                    Debug.WriteLine(Min_value & " " & Max_value)
                End If
            Else
                Max_value = 2147483647 / rgain
                Min_value = -2147483648 / rgain
            End If
            Dim num_keyboard As New Numeric_Keyboard(WriteAddress, Val(Me.Text), Min_value, Max_value, Gain, "32BIT", recordev.ToString, RecordMessage, RecordActionMessage)
            num_keyboard.TopMost = True
            num_keyboard.StartPosition = FormStartPosition.CenterParent
            num_keyboard.ShowDialog()
        End If
    ...
    Sub updatevalue()
        ...
        'Dim TagName As String = "receipe_p_1(0)"
        If variableclass.is_encrypted Then
